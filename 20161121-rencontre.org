...
** Pourquoi ça marche?
- Ma principale question est de savoir pourquoi je peux toujours réparer
...
- Cette activité peut venir après le 5x5 de magie que Marie adore.
...
* Pascal Lafourcade : notion de variable (non dans cargo bot)  
