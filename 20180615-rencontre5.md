...
* Quatre activités montées : 
  ...
  * problème de l'arrêt : des programmes scratch qui s'arrêtent ou pas pour introduire le problème. Codage d'une machine qui duplique son entrée, boite noire pour une machine qui décide de l'arrêt, machine qui boucle si la précédente dit oui. On fait réfléchir l'élève sur la possibilité de la boîte noire (Pascal avait vu une video quelque part)
